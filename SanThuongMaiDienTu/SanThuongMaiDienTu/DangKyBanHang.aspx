<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangKyBanHang.aspx.cs" Inherits="SanThuongMaiDienTu.DangKyBanHang" %>
            ...
            <div class="auth-form" id="auth-form-register">
                <div class="auth-form_container" id="auth-form_container-register">
                    <div class="auth-form_header">
                        <h3 class="auth-form_heading">Đăng ký bán hàng</h3>
                       
                    </div>

                    <div class="auth-form_form">
                        <div class="auth-form_group">
                            <asp:TextBox ID="txtTenShop" runat="server" CssClass="auth-form_input" placeholder="Nhập tên shop của bạn"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" SetFocusOnError="true" Display="Dynamic" ControlToValidate="txtTenShop" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>

                        
                        <div class="auth-form_group">
                            <asp:TextBox ID="txtSDT" runat="server" CssClass="auth-form_input" placeholder="Nhập số điện thoại của shop bạn"></asp:TextBox>
                        ...
                        <div class="auth-form_group">
                            <asp:TextBox ID="txtDiaChi" runat="server" CssClass="auth-form_input" placeholder="Nhập địa chỉ shop của bạn"></asp:TextBox>
